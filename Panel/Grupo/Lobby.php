...
try
{
	...
	if(!is_a($grupo, 'Grupo'))
		$errorFatal = 'El grupo parece no ser válido';
}
catch(Exception $e)
{
...
<title><?php echo (is_a($grupo, 'Grupo')) ? "$grupo->Nombre: Lobby" : 'Grupos'; ?>- Club Orión de Astronomía</title>
<!-- InstanceEndEditable -->
...
<link href="../../Estilos/General/Grupo.css" rel="stylesheet" type="text/css" />
<!-- InstanceEndEditable -->
</head>
...
?>
        ...
        <div id="ContenedorGeneralLobby">
        <div id="ContenidoPrincipalGrupo">
        <p>Se supone que aquí va el contenido del grupo. El Livestream que se encuentra en esta página es único por pgrupo, o sea que cada grupo tendrá su propio chat. En la página principal tengo pensado colocar otra cosa, pero primero hay que organziar esta cosa bien bien, ya que no tengo qué más color, por el momento.</p>
        </div>
          <div class="ChatSocial">
            <div id="fb-root"></div>
            <script src="http://connect.facebook.net/en_US/all.js#appId=132461856821657&amp;xfbml=1"></script>
            <fb:live-stream event_app_id="132461856821657" width="400" height="500" xid="<?php echo sha1("GruposAfC10B81::$grupo->Id"); ?>" always_post_to_friends="false"></fb:live-stream>
          </div>
        </div>
        <?php
}
	...
	echo MensajeHtml::JqueryUiError('Por alguna buena razón no puedes ver la información de este grupo');
?>
