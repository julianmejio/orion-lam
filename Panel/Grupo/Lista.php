...
<title>Mis grupos - Club Orión de Astronomía</title>
<!-- InstanceEndEditable -->
...
?></li>
        ...
        <h1>¿Qué son los grupos?</h1>
        <p>Los grupos relacionan integrantes del club para diferentes actividades, como sub-grupos académicos o los diferentes comités. Estar en un grupo significa mayor oportunidad de participación, además de colaborar con el desarrollo de este.</p>
        <p>Para estar en un grupo primero debes ser miembro activo del club, y por ende haber asistido por lo menos a {Binding Path=Config::MIN_ROF_MC} reuniones oficiales.</p>
        <h2>Mis grupos</h2>
          <?php
if(is_array($grupos))
{
?>
        <table class="TablaAccion">
          <tr>
            <th scope="col" style="width: 70%">Grupo</th>
...
?>
          <tr>
            <td><strong><?php echo $grupo->Nombre; ?></strong><br/><a href="Lobby.php?g=<?php echo $grupo->Id; ?>">Lobby</a>, <a href="Usuarios.php?g=<?php echo $grupo->Id; ?>">Usuarios</a><?php if($grupo->Descripcion != null) echo "<br />$grupo->Descripcion"; ?></td>
            <td style="text-align:center"><?php echo ($grupo->EsAdministrador($usuarioActivo)) ? 'Administrador' : 'Miembro'; ?></td>
...
<?php
	...
	echo MensajeHtml::JqueryUiError('¡Ups! No perteneces a ningún grupo');
?>
